...
username="$USER"
    ...
    exp_dir="${local_dir}/eval-scripts/experiments"
...
#    dcl_config_full="${cops_dir}/vicci_dcl_config/${dcl_config}"
    dcl_config_full="${local_dir}/eval-scripts/vicci_dcl_config/${dcl_config}"
    ...
    client_config_full="${local_dir}/eval-scripts/vicci_dcl_config/${client_config}"
